...
asmlinkage void do_gsexc(struct pt_regs *regs, u32 diag1)
{
	...
	case 0x08:
		 ...
		 * also-undocumented instructions. Processor state is not
		 * otherwise corrupted, but currently we don't know how to
		 * proceed. Maybe there is some undocumented control flag to
