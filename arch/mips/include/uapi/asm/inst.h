...
struct loongson3_csr_format {	/* Loongson-3 R4+ CSR instructions format */
	__BITFIELD_FIELD(unsigned int opcode : 6,
	__BITFIELD_FIELD(unsigned int rs : 5,
	__BITFIELD_FIELD(unsigned int func1 : 5,
	__BITFIELD_FIELD(unsigned int rd : 5,
	__BITFIELD_FIELD(unsigned int func2 : 5,
	__BITFIELD_FIELD(unsigned int opcode1 : 6,
	;))))))
};
...
union mips_instruction {
	...
	struct loongson3_csr_format loongson3_csr_format;
};
